...
export function CpuChipIcon(props: SVGAttributes<SVGElement>) {
  return (
    <svg
      {...props}
      aria-hidden="true"
...
export function SeedSprout(props: SVGAttributes<SVGElement>) {
  return (
    <svg
    {...props}
      aria-hidden="true"
...
export function Handshake(props: SVGAttributes<SVGElement>) {
  return (
    <svg
    {...props}
      aria-hidden="true"
...
export function FinanceChart(props: SVGAttributes<SVGElement>) {
  return (
    <svg
      {...props}
      aria-hidden="true"
...
export function TikTokIcon(props: SVGAttributes<SVGElement>) {
  return (
    <svg
      {...props}
      aria-hidden="true"
