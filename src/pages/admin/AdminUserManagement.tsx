      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <select
            ...
            className="bg-slate-900 border border-white/10 rounded-md px-3 py-2 text-sm text-slate-300 focus:outline-none focus:ring-1 focus:ring-emerald-500/20 appearance-none min-w-[140px]"
          >
