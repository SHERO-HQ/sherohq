        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex bg-slate-900 p-1 rounded border border-white/10">
            <button
              ...
              className={cn(
                "px-4 py-2 rounded text-sm font-bold transition-all flex items-center gap-2",
                mode === "invoice"
            ...
            <Card className="bg-slate-900 border-white/5 p-6 space-y-6">
              ...
              <div className="relative">
                ...
                {searchQuery && products.length > 0 && (
                  <div className="absolute top-full left-0 right-0 mt-1 bg-slate-800 border border-white/10 rounded shadow-xl z-50 max-h-60 overflow-y-auto">
                    {isLoadingProducts ? (
