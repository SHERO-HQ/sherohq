              ...
              filteredConsultations.map((c) => (
                ...
                >
                  <CardHeader className="pb-4">
                    ...
                    <CardTitle className="text-white text-lg font-sora">
                      {c.name}
                    </CardTitle>
                  ...
                  <div className="p-4 pt-0">
                    {c.status !== "Confirmed" && (
                      <Button
                        variant="outline"
                        onClick={() =>
                          handleUpdateStatus("consultation", c.id, "Confirmed")
                        }
                    ...
                    filteredInquiries.map((inquiry) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-6">
                          <Badge
                            variant="outline"
                            className="border-white/10 text-slate-300 font-mono text-[10px] tracking-tight truncate max-w-[150px]"
                          >
