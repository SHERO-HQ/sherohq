            ...
            {!recoveryCodes ? (
              <>
                <div className="space-y-2 text-center">
                  ...
                  <h3 className="text-lg font-bold">Verify Code</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-blue-600 hover:bg-blue-700 disabled:opacity-80 text-white rounded font-medium transition-colors flex items-center justify-center gap-2"
                  >
