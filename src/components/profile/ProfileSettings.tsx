  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              {user.emailVerified ? (
                ...
                <span className="inline-flex items-center gap-1 text-xs font-semibold text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/40 px-2 py-0.5 rounded">
                  Unverified
                </span>
              )}
            </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded border border-slate-200 dark:border-slate-800 p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded border border-slate-100 dark:border-slate-800">
