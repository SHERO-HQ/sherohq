      ...
      <div className="hidden lg:block lg:col-span-1">
        <div className="bg-white dark:bg-slate-900 rounded shadow border border-slate-200 dark:border-slate-800 p-6 sticky top-24">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-16 h-16 rounded  font-sora font-bold bg-linear-to-br from-emerald-500 to-emerald-600 flex items-center justify-center text-3xl text-white shrink-0 shadow-lg">
              {user.name.charAt(0)}
            </div>
            <div>
              <h2 className="font-bold font-sora text-slate-900 dark:text-white line-clamp-1">
                {user.name}
              </h2>
