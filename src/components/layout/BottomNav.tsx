              ...
              return (
                ...
                >
                  ...
                  {mounted && totalQuantity > 0 && (
                    <span className="absolute top-1 right-1/2 translate-x-4 flex h-4 w-4 items-center justify-center rounded-full bg-brand-secondary-600 text-[8px] font-bold text-white">
                      {totalQuantity}
                    </span>
                  )}
                </button>
