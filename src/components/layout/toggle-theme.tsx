  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          <Sun className="h-4 w-4 scale-100 rotate-0 transition dark:scale-0 dark:-rotate-90 text-slate-700" />
          <Moon className="absolute h-4 w-4 scale-0 rotate-90 transition dark:scale-100 dark:rotate-0 text-slate-300" />
