            ...
            <div className="space-y-3">
              ...
              >
                <input
                  ...
                  className="flex-1 px-4 py-3 text-sm bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-emerald-500/50 outline-none transition-all"
                />
                <button
                  type="submit"
