...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
    <div ref={ref} className={cn("rounded border bg-card text-card-foreground shadow-md", "dark:shadow-xl dark:shadow-black/20 dark:border-white/10", className)} {...props} />
));
