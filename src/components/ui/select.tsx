...
const Select = React.forwardRef<HTMLSelectElement, SelectProps>(
 ...
 id={selectId}
 className={cn(
 "flex h-9 w-full rounded border border-input bg-transparent text-foreground px-3 py-1 text-sm shadow-sm transition-colors focus-visible:outline-none focus-visible:border-brand-primary-500 focus-visible:ring-2 focus-visible:ring-brand-primary-500/20 disabled:cursor-not-allowed disabled:opacity-50 appearance-none cursor-pointer",
