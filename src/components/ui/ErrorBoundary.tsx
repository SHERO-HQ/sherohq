...
export class ErrorBoundary extends Component<Props, State> {
 ...
 className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-brand-secondary-600 text-white rounded hover:bg-brand-secondary-500 transition-colors"
 >
