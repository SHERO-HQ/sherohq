      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="pt-4">
          <Button
            ...
            className="w-full h-14 text-lg font-bold bg-emerald-600 hover:bg-emerald-700 text-white rounded shadow-lg shadow-emerald-500/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
            {status === "idle" && (
              <>
