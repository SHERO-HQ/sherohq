...
const SolutionsHero = () => {
 ...
 className="relative w-full min-h-screen md:h-[90vh] flex items-center pt-10 pb-10 lg:py-0 overflow-hidden bg-slate-50 dark:bg-slate-950"
 >
 <HeroBackground />
 ...
 <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-slate-900 dark:text-white leading-[1.05] tracking-tighter mb-6 lg:mb-8">
 ...
 {/* Main Visual Card */}
 <div className="relative w-full h-full group-hover/visual:-translate-y-6 transition-transform duration-1000 ease-out flex items-center justify-center">
