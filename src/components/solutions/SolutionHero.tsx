      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-2xl md:text-5xl lg:text-7xl font-sora font-bold text-slate-900 dark:text-slate-100 mb-6 leading-tight"
          >
            Technology Ecosystems <br />
            <span className="text-3xl md:text-6xl lg:text-8xl text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-blue-600 dark:from-emerald-400 dark:to-blue-400">
