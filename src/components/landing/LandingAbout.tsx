...
const LandingAbout = () => {
 ...
 <div className="absolute -top-24 right-0 dark:bg-emerald-50/10 bg-white/40 backdrop-blur-sm border border-white/20 dark:border-emerald-500/20 px-4 py-2 rounded transform translate-y-1/2 shadow">
