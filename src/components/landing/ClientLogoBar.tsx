...
export const ClientLogoBar = () => {
  ...
  return (
    <section className="relative w-full py-12 sm:py-16 md:py-20 overflow-hidden bg-linear-to-b from-white via-slate-50/70 to-white dark:from-slate-950 dark:via-slate-900/35 dark:to-slate-950 border-y border-slate-200/50 dark:border-slate-800/50">
          ...
          <ul className="flex flex-wrap items-center justify-center gap-12 sm:gap-16 md:gap-24 lg:gap-28 w-full max-w-5xl">
            {clientList.map((client) => {
              ...
              const content = (
                <>
                  ...
                  <Image
                    ...
                    width={180}
                    height={56}
                    className={`h-10 sm:h-12 md:h-14 w-auto max-w-[180px] sm:max-w-[220px] object-contain filter grayscale opacity-60 transition-[opacity,filter] duration-300 hover:grayscale-0 hover:opacity-100 hover:drop-shadow-[0_0_12px_rgba(0,180,216,0.25)] ${logoDarkUrl
                        ? "dark:hidden block"
                  ...
                  {logoDarkUrl && (
                    <Image
                      ...
                      width={180}
                      height={56}
                      className="h-10 sm:h-12 md:h-14 w-auto max-w-[180px] sm:max-w-[220px] object-contain filter grayscale opacity-70 transition-[opacity,filter] duration-300 hidden dark:block hover:grayscale-0 hover:opacity-100 hover:drop-shadow-[0_0_12px_rgba(0,180,216,0.3)]"
                    />
                  )}
                </>
              );
              ...
              return (
                <li
                  key={client.id}
                  className="flex items-center justify-center transition-transform duration-300 hover:scale-108 hover:-translate-y-0.5 cursor-pointer"
                  title={client.name}
                >
                  {client.website ? (
                    <a
