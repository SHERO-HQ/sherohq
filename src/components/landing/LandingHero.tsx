          ...
          <div className="w-full lg:w-[56%] flex flex-col items-start gap-5 text-left">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <p className="flex items-center gap-2 mt-1 text-lg font-sora font-bold text-slate-900 dark:text-white">
                ...
                <div className="backdrop-blur px-4 py-3">
                  ...
                  <p className="mt-1 flex items-center gap-2 text-lg font-sora font-bold text-slate-900 dark:text-white">
            ...
            >
                ...
                <div className="space-y-3">
                  {[
                    ...
                    >
                      ...
                      <div>
                        <h5 className="text-sm font-sora font-semibold text-slate-900 dark:text-white">
                          {item.title}
                        </h5>
              ...
              >
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  <span className="text-sm font-sora font-bold text-slate-900 dark:text-white">
                    Fast fulfillment
                  </span>
                </div>
