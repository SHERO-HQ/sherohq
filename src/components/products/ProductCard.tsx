    ...
    >
      ...
      <div className="relative aspect-3/4 sm:aspect-4/5 lg:aspect-3/4 bg-slate-100 dark:bg-slate-900 overflow-hidden shrink-0">
        ...
        <div className="absolute bottom-3 left-3 z-20 flex flex-wrap gap-1">
          {product.badge && (
            <span className="px-2.5 py-1 rounded text-[11px] font-semibold uppercase tracking-tight bg-brand-secondary-600 text-white">
              {product.badge}
            </span>
          )}
          {discount > 0 && (
            <span className="px-2.5 py-1 rounded text-[11px] font-semibold uppercase tracking-tight bg-red-600 text-white">
              -{discount}%
            </span>
          )}
          {!product.inStock && (
            <span className="px-2.5 py-1 rounded text-[11px] font-semibold uppercase tracking-tight bg-slate-900/80 text-white ">
              Sold Out
            </span>
          )}
        </div>
