  ...
  return (
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <h2 className="text-3xl font-black font-sora text-slate-900 dark:text-white uppercase tracking-tighter mb-2">
        ...
        <div className="lg:col-span-5 h-fit lg:sticky lg:top-24">
          <div className="p-8 rounded bg-white dark:bg-white/5 backdrop-blur-sm border border-slate-200 dark:border-white/10 shadow-md overflow-hidden relative group">
            ...
            <div className="relative">
              <h3 className="text-xl font-black font-sora text-slate-900 dark:text-white mb-6 uppercase tracking-tight flex items-center gap-2">
