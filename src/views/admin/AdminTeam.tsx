...
const AdminTeam = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addNotification(
        "Error",
        getErrorMessage(error, "Failed to save team member"),
        "error",
      );
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      addNotification(
        "Error",
        getErrorMessage(error, "Failed to delete team member"),
        "error",
      );
    }
  };
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 text-xs text-muted-foreground max-w-50">
                Recommended size: 400x400px (1:1 ratio). Will be cropped to a
                circle.
              </div>
            </div>
          </div>
