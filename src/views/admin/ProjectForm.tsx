              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[120px] bg-slate-800/50 border border-white/5 rounded p-3 text-white focus:outline-none focus:ring-1 focus:ring-emerald-500/50 resize-y"
                    required
                  />
                </div>
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-slate-900 border-white/5 p-6 space-y-4">
              <div className="flex items-center gap-2 pb-2 border-b border-white/5">
                ...
                <h3 className="font-bold text-white font-sora">Cover Image</h3>
              </div>
