          ...
          <div className="bg-white dark:bg-slate-900 rounded p-8 md:p-12 shadow-sm border border-slate-200 dark:border-slate-800 article-content">
            ...
            <div className="space-y-8 text-slate-600 dark:text-slate-400 leading-relaxed">
              <section>
                ...
                <p>
                  Welcome to SHERO Technologies ("we," "our," or "us"). By
                  accessing or using our website, products, and services, you
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    Using the service in any way that violates applicable
                    national or international law.
                  </li>
                  <li>
                    Attempting to gain unauthorized access to any portion of the
                    website or our systems.
                  </li>
                  <li>
              ...
              <section>
                ...
                <p>
                  ...
                  or other content is accurate, complete, reliable, current, or
                  error-free. Prices are subject to change without notice. All
              ...
              <section>
                ...
                <p>
                  ...
                  software, are the exclusive property of SHERO Technologies and
              ...
              <section>
                ...
                <p>
                  In no event shall SHERO Technologies, its directors,
