...
const SupportGuideDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-0 right-1/4 w-125 h-125 bg-brand-secondary-500/5 dark:bg-brand-secondary-500/10 rounded-full blur-[60px] -z-10 animate-pulse" />
      <div className="absolute bottom-0 left-1/4 w-125 h-125 bg-blue-500/5 dark:bg-blue-500/10 rounded-full blur-[60px] -z-10" />
