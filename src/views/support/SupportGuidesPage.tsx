...
const SupportGuidesPage = () => {
  ...
  return (
    <div className="pt-8 pb-12 bg-background min-h-screen text-foreground relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-0 left-1/4 w-125 h-125 bg-brand-secondary-500/5 dark:bg-brand-secondary-500/10 rounded-full blur-[60px] -z-10 animate-pulse" />
      <div className="absolute bottom-1/4 right-0 w-100 h-100 bg-blue-500/5 dark:bg-blue-500/10 rounded-full blur-[60px] -z-10" />
      ...
      <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
            <div className="flex items-center gap-5">
              <div className="w-16 h-16 bg-brand-secondary-100 dark:bg-brand-secondary-900/40 rounded flex items-center justify-center text-brand-secondary-600 dark:text-brand-secondary-400 border border-brand-secondary-200 dark:border-brand-secondary-500/20 shadow shadow-brand-secondary-500/10 shrink-0">
                {category === "software" ? (
            ...
            <div className="relative w-full max-w-md group">
              <input
                ...
                className="w-full pl-12 pr-4 py-3.5 bg-card/40 dark:bg-slate-900/40  border border-border rounded focus:ring-2 focus:ring-brand-secondary-500/50 outline-none transition text-foreground placeholder:text-muted-foreground"
              />
        ...
        {(() => {
          ...
          if (filteredGuides.length === 0) {
            return (
              <div className="text-center py-24 bg-secondary/30 dark:bg-slate-900/30 rounded border border-border ">
                        ...
                        <div className="flex items-center gap-3 text-xs text-muted-foreground">
                          ...
                          {guide.authorName && (
                            <span className="flex items-center gap-1.5">
                              <div className="w-1.5 h-1.5 rounded-full bg-brand-secondary-500/40" />
                              {guide.authorName}
                            </span>
                          )}
                        </div>
