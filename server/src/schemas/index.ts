...
export const RegisterSchema = z.object({
    ...
    phone: z
        .string()
        .regex(/^(02|05)\d{8}$/, "Invalid Ghana phone number. Must start with 02 or 05 and be 10 digits")
        .optional(),
});
...
export const AdminRegisterSchema = z.object({
    ...
    email: z.string().email("Invalid email address"),
    password: z.string().min(8, "Password must be at least 8 characters").regex(/[A-Z]/, "Must contain uppercase").regex(/[a-z]/, "Must contain lowercase").regex(/\d/, "Must contain number"),
...
export const CreateOrderSchema = z.object({
    ...
    items: z.array(OrderItemSchema).min(1, "Order must contain at least one item").max(50, "Too many items in order"),
...
export const UpdateOrderStatusSchema = z.object({
    status: z.enum(["pending", "processing", "shipped", "delivered", "cancelled", "quote"], {
...
export const CreateGuideSchema = z.object({
    ...
    category: z.enum(["hardware", "software", "troubleshooting", "setup", "maintenance"]),
